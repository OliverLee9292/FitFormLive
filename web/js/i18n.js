const translations = {
  ko: {
    ...
    avatar_male: "남성",
    avatar_female: "여성",
    avatar_view_title: "3D 아바타 모드",
    avatar_view_desc: "나의 운동 동작을 그대로 따라하는 3D 아바타! 게임처럼 즐기면서 자세를 점검해보세요.",
    challenge_view_title: "도전 모드 타이머",
    challenge_btn_1: "1분",
    challenge_btn_3: "3분",
    challenge_btn_5: "5분",
    challenge_btn_10: "10분",
    challenge_remaining_label: "남은 시간:",
  },
  en: {
    ...
    avatar_view_title: "3D Avatar Mode",
    avatar_view_desc: "A 3D avatar that mirrors your exact movements! Enjoy checking your posture like a game.",
    challenge_view_title: "Challenge Timer",
    challenge_btn_1: "1 min",
    challenge_btn_3: "3 min",
    challenge_btn_5: "5 min",
    challenge_btn_10: "10 min",
    challenge_remaining_label: "Remaining Time:",
  },
};
...
export function applyStaticText() {
  const map = {
    ...
    "avatar-view-title": "avatar_view_title",
    "avatar-view-desc": "avatar_view_desc",
    "challenge-view-title": "challenge_view_title",
    "challenge-btn-1": "challenge_btn_1",
    "challenge-btn-3": "challenge_btn_3",
    "challenge-btn-5": "challenge_btn_5",
    "challenge-btn-10": "challenge_btn_10",
    "challenge-remaining-label": "challenge_remaining_label",
  };
